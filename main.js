...
var askName = function () {
  /* Uncomment the next 3 commented lines (and remove the var call from
  where we assign a value to fullName) to keep asking this until the
  proper name is entered. */
  // var fullName;
...
/* Run askName when the page loads. */
// askName();
